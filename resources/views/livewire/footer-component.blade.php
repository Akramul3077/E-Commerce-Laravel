                                    ...
                                    <div class="item-content" >
                                        <div class="wrap-newletter-footer" > 
                                            <form action="#" class="frm-newletter" id="frm-newletter" >
                                                <input style="border-radius: 50px;" type="email" class="input-email" name="email" value="" placeholder="Enter your email address">
                                                <button class="btn-submit" style="border-top-right-radius: 50px; border-bottom-right-radius: 50px;">Subscribe</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="item-content">
                                        <div class="wrap-list-item social-network">
                                            <ul>
                                                ...
                                                <li><a href="{{$setting->youtube}}" class="link-to-item" title="youtube"><i class="fa fa-youtube"
                ...
                <div class="coppy-right-box">
                    <div class="container">
                        <div class="coppy-right-item item-left">
                            <p class="coppy-right-text">Copyright © 2021 Akramul. All rights reserved</p>
                        </div>
