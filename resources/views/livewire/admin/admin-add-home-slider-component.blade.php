                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" wire:submit.prevent="addSlide">
                            <div class="form-group">
                                <label  class="col-md-4 contorl-label">Title</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label  class="col-md-4 contorl-label">Subtitle</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label  class="col-md-4 contorl-label">Price</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label  class="col-md-4 contorl-label">Link</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label  class="col-md-4 contorl-label">Image</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label  class="col-md-4 contorl-label">Status</label>
                                <div class="col-md-4">
